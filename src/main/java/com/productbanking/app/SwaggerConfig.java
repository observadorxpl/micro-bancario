...
public class SwaggerConfig {
	...
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Finantial micro-productos-bancarios Api Documentation", "Finantial micro-productos-bancarios Api Documentation", "1.0",
